...
const Input = () => {
    ...
    return (
        <div className={`border-b border-gray-700 p-3 flex space-x-3 overflow-y-scroll`}>
            <img className="h-11 w-11 rounded-full cursor-pointer" src="https://lh3.googleusercontent.com/a/AATXAJwCsuneWAkKlHwMPxOmLNjFACEvbtN8QPwbUsZ-=s96-c" alt="" />
            ...
            <div className="w-full divide-y divide-gray-700">
                ...
                <div className="flex items-center justify-between pt-2.5">
                    ...
                    <button
                        ...
                        disabled={!input || (input && !input.trim()) && !selectedFile}
                    onClick={sendPost}
                    >Tweet
                    </button>
                </div>
